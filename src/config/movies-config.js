...
export const getMovieImgByPath = (img_ending) => {
  return `https://image.tmdb.org/t/p/w185${img_ending}`;
};

export const getSearchMovies = (str, page) =>
  `/search/movie?api_key=${API_KEY}&query=${str}&page=${page}`;
